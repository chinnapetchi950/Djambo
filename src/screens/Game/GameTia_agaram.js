...
const [showSideBetDeclined,setShowSideBetDeclined]=useState(false)
const [showSideBetsuccess,setShowSideBetsuccess]=useState(false)
...
<Text style={[styles.amountLabel,{fontSize:wp('3.8%'),textAlign:'center'}]}>Winner:Player 2</Text>
  ...
  screen: "Game",
        ...
        />
         ...
         rightLabel={'Agree'}
          visible={showsidebet}
          onCancel={() => {setshowsidebet(false),setShowSideBetDeclined(true)}}
          onConfirm={()=>{setshowsidebet(false),setShowSideBetsuccess(true)}}
          title={
            <>
            Player 1 wants to increase the {'\n'} bet by 50FCFA. Do you agree?”
            </>
          }
        />
        <StatusModal
  visible={showSideBetDeclined}
  image={require("../../../assets/images/disagree.png")}
  title={
            <>
           Side bet declined {'\n'} Pot remains 100 FCFA
            </>
          }
  
  onClose={() => setShowSideBetDeclined(false)}
/>
 <StatusModal
  visible={showSideBetsuccess}
  image={require("../../../assets/images/agree.png")}
  title={
            <>
            Side bet accepted!{'\n'}New pot 150FCFA
            </>
          }
  onClose={() => setShowSideBetsuccess(false)}
/>
    </ScreenWrapper>
  );
}
